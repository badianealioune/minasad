...
from highrise.models import ModerateRoomRequest, SessionMetadata
...
class Bot(BaseBot):
    ...
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        ...
        await self.highrise.chat(f"سلام {user.username}به اتاق خوش آمدید، سعی کنید از آن لذت ببرید❤️‍🔥🔥")
    ...
    async def on_user_leave(self, user: User) -> None:
        ...
        await self.highrise.chat(f"خداحافظ @{user.username} سعی کن دوباره برگردی، ممنون 😇")
